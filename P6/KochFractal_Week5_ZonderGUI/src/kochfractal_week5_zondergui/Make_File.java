...
/**
 * In this class you can find all properties and operations for Make_File. //CHECK
 *
 * @organization: Moridrin
 * @author J.B.A.J. Berkvens
 * @date 2014/06/03
 */
public class Make_File implements Observer {
    ...
    public static void main(String[] args) {
        Make_File console = new Make_File();
        String file;
        if (args.length < 1) {
    ...
    private void start(String fileDir) {
        ...
        try {
            ...
            Logger.getLogger(Make_File.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    //</editor-fold>
